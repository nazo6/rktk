...
>(
    mut split: SP,
    received_sender: Sender<'a, CriticalSectionRawMutex, R, { RKTK_CONFIG.split_channel_size }>,
    to_send_receiver: Receiver<'a, CriticalSectionRawMutex, S, { RKTK_CONFIG.split_channel_size }>,
    is_master: bool,
) {
