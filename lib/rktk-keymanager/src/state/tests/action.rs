...
fn normal_action() {
    ...
    keymap.layers[0][0][0] = KeyAction::Normal(KeyCode::Key(Key::A));
...
fn normal2_action() {
    let mut keymap = EMPTY_KEYMAP;
    keymap.layers[0][0][0] = KeyAction::Normal2(KeyCode::Key(Key::A), KeyCode::Key(Key::B));
...
fn taphold_action_hold() {
    let mut keymap = EMPTY_KEYMAP;
    keymap.layers[0][0][0] = KeyAction::TapHold(KeyCode::Key(Key::A), KeyCode::Key(Key::B));
...
fn taphold_action_other_key_press() {
    ...
    keymap.layers[1][0][1] = KeyAction::Normal(KeyCode::Key(Key::C));
...
fn oneshot_action_mod() {
    let mut keymap = EMPTY_KEYMAP;
    keymap.layers[0][0][0] = KeyAction::OneShot(KeyCode::Modifier(Modifier::LCtrl));
    keymap.layers[0][0][1] = KeyAction::Normal(KeyCode::Key(Key::A));
    keymap.layers[0][0][2] = KeyAction::Normal(KeyCode::Key(Key::B));
