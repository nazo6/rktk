...
type DriverType = Driver<'static, USBD, &'static SoftwareVbusDetect>;
...
pub struct UsbDriver {
    hid: HidReaderWriters<'static, DriverType>,
    wakeup_signal: &'static RemoteWakeupSignal,
}

impl UsbDriver {
    pub async fn create_and_start(user_opts: UsbUserOpts<'static>, driver: DriverType) -> Self {
...
async fn start_usb(
    mut device: UsbDevice<'static, DriverType>,
